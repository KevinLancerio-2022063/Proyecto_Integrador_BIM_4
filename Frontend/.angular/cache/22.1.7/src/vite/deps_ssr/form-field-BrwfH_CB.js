import { A as contentChild, Bt as computed, Ca as ɵɵconditional, Da as ɵɵcontentQuerySignal, Dc as InjectionToken, Dr as ViewEncapsulation, Ea as ɵɵcontentQuery, En as ElementRef, Gs as ɵɵtextInterpolate, Hs as ɵɵtemplate, Ic as NgZone, In as Input, Ol as ɵɵdefineInjector, S as ViewChild, Sl as signal, T as afterRenderEffect, Ta as ɵɵconditionalCreate, Us as ɵɵtemplateRefExtractor, Wi as setClassMetadata, Ws as ɵɵtext, Xo as ɵɵloadQuery, Yo as ɵɵlistener, Zo as ɵɵnextContext, _s as ɵɵqueryAdvance, a as ContentChildren, ao as ɵɵdefineService, ar as RendererFactory2, as as ɵɵprojectionDef, bo as ɵɵelementEnd, bs as ɵɵreference, cc as ɵɵviewQuerySignal, cl as inject, cn as Component, da as ɵɵadvance, do as ɵɵdomElementEnd, dr as Service, fo as ɵɵdomElementStart, go as ɵɵelement, gt as viewChild, i as ContentChild, il as forwardRef, ir as Renderer2, is as ɵɵprojection, lc as require_operators, mo as ɵɵdomProperty, nl as effect, no as ɵɵdefineDirective, os as ɵɵproperty, qn as NgModule, r as ChangeDetectorRef, ro as ɵɵdefineNgModule, sc as ɵɵviewQuery, so as ɵɵdomElement, to as ɵɵdefineComponent, ua as ɵɵProvidersFeature, vs as ɵɵqueryRefresh, wn as Directive, xa as ɵɵclassProp, xo as ɵɵelementStart, ya as ɵɵattribute } from "./core-BTdOnYNV.js";
import { t as require_cjs } from "./rxjs.js";
import { i as Directionality, t as BidiModule } from "./bidi-BHFf4Uzt.js";
import { Y as NgTemplateOutlet } from "./common-m55dzbwS.js";
import { t as Platform } from "./_platform-chunk-W0nvhfHD.js";
import { a as ObserversModule } from "./a11y-CsRYjtKe.js";
...
var SingleBoxSharedResizeObserver = class {
	...
	_resizeSubject = new import_cjs.Subject();
	_resizeObserver;
	...
	observe(target) {
		if (!this._elementObservables.has(target)) this._elementObservables.set(target, new import_cjs.Observable((observer) => {
...
var MatFormFieldFloatingLabel = class MatFormFieldFloatingLabel {
	...
	_resizeSubscription = new import_cjs.Subscription();
	ngOnDestroy() {
...
var MatFormField = class MatFormField {
	...
	_initializeControl(previousControl) {
		...
		this._valueChanges?.unsubscribe();
		if (control.ngControl && control.ngControl.valueChanges) this._valueChanges = control.ngControl.valueChanges.pipe((0, import_operators.takeUntil)(this._destroyed)).subscribe(() => this._changeDetectorRef.markForCheck());
	}
	...
	_initializePrefixAndSuffix() {
		...
		(0, import_cjs.merge)(this._prefixChildren.changes, this._suffixChildren.changes).subscribe(() => {
			this._checkPrefixAndSuffixTypes();
			this._changeDetectorRef.markForCheck();
		});
	}
