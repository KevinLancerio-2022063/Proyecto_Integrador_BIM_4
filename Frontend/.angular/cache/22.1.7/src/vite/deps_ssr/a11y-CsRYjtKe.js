import { $n as Output, Dc as InjectionToken, En as ElementRef, Ic as NgZone, In as Input, Mr as afterNextRender, O as booleanAttribute, Oc as Injector, Ol as ɵɵdefineInjector, Wi as setClassMetadata, ao as ɵɵdefineService, ar as RendererFactory2, cl as inject, dc as APP_ID, dr as Service, hc as DOCUMENT, la as ɵɵNgOnChangesFeature, lc as require_operators, no as ɵɵdefineDirective, qn as NgModule, ro as ɵɵdefineNgModule, wn as Directive, xc as EventEmitter } from "./core-BTdOnYNV.js";
...
import { n as _setInnerHtml, t as _VisuallyHiddenLoader } from "./private-BQDHN_zd.js";
import { r as BreakpointObserver } from "./_animation-chunk-DsuHc7w2.js";
import { r as DomSanitizer } from "./platform-browser-Cx-A4ZJ2.js";
...
var InputModalityDetector = class InputModalityDetector {
	...
	_modality = new import_cjs.BehaviorSubject(null);
	_options;
	_lastTouchMs = 0;
	_onKeydown = (event) => {
...
var FocusMonitor = class FocusMonitor {
	...
	_stopInputModalityDetector = new import_cjs.Subject();
	constructor() {
	...
	monitor(element, checkChildren = false) {
		...
		if (!this._platform.isBrowser || nativeElement.nodeType !== 1) return (0, import_cjs.of)();
		...
		const info = {
			checkChildren,
			subject: new import_cjs.Subject(),
			rootNode
		};
...
var ContentObserver = class ContentObserver {
	...
	observe(elementOrRef) {
		...
		return new import_cjs.Observable((observer) => {
			const subscription = this._observeElement(element).pipe((0, import_operators.map)((records) => records.filter((record) => !shouldIgnoreRecord(record))), (0, import_operators.filter)((records) => !!records.length)).subscribe((records) => {
				this._ngZone.run(() => {
	...
	_observeElement(element) {
		return this._ngZone.runOutsideAngular(() => {
			if (!this._observedElements.has(element)) {
				const stream = new import_cjs.Subject();
...
//#endregion
export { ObserversModule as a, _getEventTarget as c, isFakeTouchstartFromScreenReader as d, LiveAnnouncer as i, _getFocusedElementPierceShadowDom as l, FocusTrapFactory as n, FocusMonitor as o, InteractivityChecker as r, normalizePassiveListenerOptions as s, A11yModule as t, isFakeMousedownFromScreenReader as u };
