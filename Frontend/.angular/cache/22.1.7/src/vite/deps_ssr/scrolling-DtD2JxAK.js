import { $n as Output, Dc as InjectionToken, Dr as ViewEncapsulation, En as ElementRef, Er as ViewContainerRef, Ic as NgZone, In as Input, Mr as afterNextRender, O as booleanAttribute, Oc as Injector, Ol as ɵɵdefineInjector, Oo as ɵɵgetInheritedFactory, S as ViewChild, Sl as signal, Wi as setClassMetadata, Xo as ɵɵloadQuery, ao as ɵɵdefineService, ar as RendererFactory2, as as ɵɵprojectionDef, ca as ɵɵInheritDefinitionFeature, cl as inject, cn as Component, da as ɵɵadvance, do as ɵɵdomElementEnd, dr as Service, fo as ɵɵdomElementStart, gc as DestroyRef, hc as DOCUMENT, il as forwardRef, ir as Renderer2, is as ɵɵprojection, la as ɵɵNgOnChangesFeature, lc as require_operators, nl as effect, no as ɵɵdefineDirective, p as IterableDiffers, qn as NgModule, qt as untracked, r as ChangeDetectorRef, ro as ɵɵdefineNgModule, sc as ɵɵviewQuery, so as ɵɵdomElement, tn as ApplicationRef, to as ɵɵdefineComponent, ua as ɵɵProvidersFeature, vr as TemplateRef, vs as ɵɵqueryRefresh, wn as Directive, xa as ɵɵclassProp, zs as ɵɵstyleProp } from "./core-BTdOnYNV.js";
...
import { n as coerceNumberProperty, t as coerceElement } from "./_element-chunk-DJR_YHrx.js";
...
function isDataSource(value) {
	return value && typeof value.connect === "function" && !(value instanceof import_cjs.ConnectableObservable);
}
//#endregion
...
var ArrayDataSource = class extends DataSource {
	...
	connect() {
		return (0, import_cjs.isObservable)(this._data) ? this._data : (0, import_cjs.of)(this._data);
	}
	disconnect() {}
};
...
var FixedSizeVirtualScrollStrategy = class {
	_scrolledIndexChange = new import_cjs.Subject();
...
var ScrollDispatcher = class ScrollDispatcher {
	...
	_scrolled = new import_cjs.Subject();
	_scrolledCount = 0;
	...
	scrolled(auditTimeInMs = 20) {
		if (!this._platform.isBrowser) return (0, import_cjs.of)();
...
var CdkScrollable = class CdkScrollable {
	...
	_cleanupScroll;
	_elementScrolled = new import_cjs.Subject();
	ngOnInit() {
...
var ViewportRuler = class ViewportRuler {
	...
	_listeners;
	_viewportSize = null;
	_change = new import_cjs.Subject();
...
var SCROLL_SCHEDULER = typeof requestAnimationFrame !== "undefined" ? import_cjs.animationFrameScheduler : import_cjs.asapScheduler;
...
var CdkVirtualScrollViewport = class CdkVirtualScrollViewport extends CdkVirtualScrollable {
	...
	_platform = inject(Platform);
	_detachedSubject = new import_cjs.Subject();
	_renderedRangeSubject = new import_cjs.Subject();
	_renderedContentOffsetSubject = new import_cjs.Subject();
	get orientation() {
	...
	appendOnly = false;
	scrolledIndexChange = new import_cjs.Observable((observer) => this._scrollStrategy.scrolledIndexChange.subscribe((index) => Promise.resolve().then(() => this.ngZone.run(() => observer.next(index)))));
	_contentWrapper;
	...
	_viewportChanges = import_cjs.Subscription.EMPTY;
...
var CdkVirtualForOf = class CdkVirtualForOf {
	...
	viewChange = new import_cjs.Subject();
	...
	set cdkVirtualForOf(value) {
		...
		else this._dataSourceChanges.next(new ArrayDataSource((0, import_cjs.isObservable)(value) ? value : Array.from(value || [])));
	}
	_cdkVirtualForOf;
	...
	_changeDataSource(oldDs, newDs) {
		...
		this._needsUpdate = true;
		return newDs ? newDs.connect(this) : (0, import_cjs.of)();
	}
	_updateContext() {
