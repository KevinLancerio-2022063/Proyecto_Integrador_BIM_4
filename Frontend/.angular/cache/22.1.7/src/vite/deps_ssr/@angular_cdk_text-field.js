import { $n as Output, Dr as ViewEncapsulation, En as ElementRef, Ic as NgZone, In as Input, O as booleanAttribute, Ol as ɵɵdefineInjector, Wi as setClassMetadata, Yo as ɵɵlistener, ao as ɵɵdefineService, ar as RendererFactory2, cl as inject, cn as Component, dr as Service, hc as DOCUMENT, ir as Renderer2, lc as require_operators, no as ɵɵdefineDirective, qn as NgModule, ro as ɵɵdefineNgModule, to as ɵɵdefineComponent, wn as Directive, xc as EventEmitter } from "./core-BTdOnYNV.js";
...
var AutofillMonitor = class AutofillMonitor {
	...
	monitor(elementOrRef) {
		if (!this._platform.isBrowser) return import_cjs.EMPTY;
		this._styleLoader.load(_CdkTextFieldStyleLoader);
		const element = coerceElement(elementOrRef);
		const info = this._monitoredElements.get(element);
		if (info) return info.subject;
		const subject = new import_cjs.Subject();
...
var CdkTextareaAutosize = class CdkTextareaAutosize {
	...
	_resizeEvents = new import_cjs.Subject();
	_previousValue;
	_initialHeight;
