...
import { $n as Output, Dc as Injector, Dl as ɵɵdefineInjector, Do as ɵɵgetInheritedFactory, Dr as ViewEncapsulation, Ec as InjectionToken, En as ElementRef, Er as ViewContainerRef, Gs as ɵɵtextInterpolate1, In as Input, Mr as afterNextRender, O as booleanAttribute, Rs as ɵɵstyleProp, S as ViewChild, Sa as ɵɵconditional, Ta as ɵɵcontentQuery, Ui as setClassMetadata, Us as ɵɵtext, Vs as ɵɵtemplate, Xo as ɵɵnextContext, Yo as ɵɵloadQuery, _o as ɵɵelementContainerEnd, _s as ɵɵqueryRefresh, a as ContentChildren, an as ChangeDetectionStrategy, ba as ɵɵclassProp, bc as EventEmitter, bo as ɵɵelementStart, ca as ɵɵNgOnChangesFeature, cc as require_operators, cn as Component, eo as ɵɵdefineComponent, f as HostAttributeToken, go as ɵɵelementContainer, i as ContentChild, is as ɵɵprojectionDef, la as ɵɵProvidersFeature, mc as DOCUMENT, no as ɵɵdefineNgModule, oc as ɵɵviewQuery, p as IterableDiffers, qn as NgModule, r as ChangeDetectorRef, rs as ɵɵprojection, sa as ɵɵInheritDefinitionFeature, sl as inject, to as ɵɵdefineDirective, ua as ɵɵadvance, vo as ɵɵelementContainerStart, vr as TemplateRef, wa as ɵɵconditionalCreate, wn as Directive, yo as ɵɵelementEnd } from "./core-Cf1yj7rw.js";
import { i as Directionality, t as BidiModule } from "./bidi-schyyYqA.js";
import { t as Platform } from "./_platform-chunk-C28Z2M7h.js";
import { t as _isNumberValue } from "./_element-chunk-BgtVBXwB.js";
import { S as isDataSource, _ as ViewportRuler, b as _ViewRepeaterOperation, m as ScrollingModule, t as CDK_VIRTUAL_SCROLL_VIEWPORT, x as DataSource, y as _RecycleViewRepeaterStrategy } from "./scrolling-COXiENFD.js";
...
var CdkTable = class CdkTable {
	...
	_data;
	_renderedRange;
	_onDestroy = new import_cjs.Subject();
	_renderRows;
	...
	_headerRowStickyUpdates = new import_cjs.Subject();
	_footerRowStickyUpdates = new import_cjs.Subject();
	...
	_dataSource;
	_dataSourceChanges = new import_cjs.Subject();
	_dataStream = new import_cjs.Subject();
	...
	viewChange = new import_cjs.BehaviorSubject({
		start: 0,
	...
	_observeRenderChanges() {
		...
		else if ((0, import_cjs.isObservable)(this.dataSource)) dataStream = this.dataSource;
		else if (Array.isArray(this.dataSource)) dataStream = (0, import_cjs.of)(this.dataSource);
		if (dataStream === void 0 && (typeof ngDevMode === "undefined" || ngDevMode)) throw getTableUnknownDataSourceError();
		this._renderChangeSubscription = (0, import_cjs.combineLatest)([dataStream, this.viewChange]).pipe((0, import_operators.takeUntil)(this._onDestroy)).subscribe(([data, range]) => {
			this._data = data || [];
	...
	_setupStickyStyler() {
		...
		(this._dir ? this._dir.change : (0, import_cjs.of)()).pipe((0, import_operators.takeUntil)(this._onDestroy)).subscribe((value) => {
			this._stickyStyler.direction = value;
			this.updateStickyColumnStyles();
		});
	}
	_setupVirtualScrolling(viewport) {
		const virtualScrollScheduler = typeof requestAnimationFrame !== "undefined" ? import_cjs.animationFrameScheduler : import_cjs.asapScheduler;
		...
		(0, import_cjs.combineLatest)([viewport.renderedContentOffset, this._headerRowStickyUpdates]).pipe((0, import_operators.takeUntil)(this._onDestroy)).subscribe(([offsetFromTop, update]) => {
		...
		(0, import_cjs.combineLatest)([viewport.renderedContentOffset, this._footerRowStickyUpdates]).pipe((0, import_operators.takeUntil)(this._onDestroy)).subscribe(([offsetFromTop, update]) => {
			if (!update.sizes || !update.offsets || !update.elements) return;
			for (let i = 0; i < update.elements.length; i++) {
				const cells = update.elements[i];
