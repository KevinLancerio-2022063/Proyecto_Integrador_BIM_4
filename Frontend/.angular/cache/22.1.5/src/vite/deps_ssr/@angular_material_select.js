...
import { $n as Output, Dc as Injector, Dl as ɵɵdefineInjector, Do as ɵɵgetInheritedFactory, Dr as ViewEncapsulation, Ec as InjectionToken, En as ElementRef, Eo as ɵɵgetCurrentView, Er as ViewContainerRef, Fc as NgZone, Fl as ɵɵresetView, Gs as ɵɵtextInterpolate1, Il as ɵɵrestoreView, In as Input, Jo as ɵɵlistener, M as createComponent, Mr as afterNextRender, O as booleanAttribute, Pl as ɵɵnamespaceSVG, S as ViewChild, Sa as ɵɵconditional, Ta as ɵɵcontentQuery, Ui as setClassMetadata, Us as ɵɵtext, Vs as ɵɵtemplate, Ws as ɵɵtextInterpolate, Xo as ɵɵnextContext, Yo as ɵɵloadQuery, Zn as NgModuleRef$1, _s as ɵɵqueryRefresh, a as ContentChildren, ar as RendererFactory2, as as ɵɵproperty, ba as ɵɵclassProp, bc as EventEmitter, bo as ɵɵelementStart, ca as ɵɵNgOnChangesFeature, cc as require_operators, cn as Component, do as ɵɵdomElementStart, dr as Service, eo as ɵɵdefineComponent, f as HostAttributeToken, ho as ɵɵelement, i as ContentChild, io as ɵɵdefineService, ir as Renderer2, is as ɵɵprojectionDef, la as ɵɵProvidersFeature, lc as ANIMATION_MODULE_TYPE, mc as DOCUMENT, no as ɵɵdefineNgModule, nr as QueryList, oc as ɵɵviewQuery, po as ɵɵdomProperty, qn as NgModule, r as ChangeDetectorRef, rs as ɵɵprojection, rt as numberAttribute, sa as ɵɵInheritDefinitionFeature, sl as inject, tl as effect, tn as ApplicationRef, to as ɵɵdefineDirective, ua as ɵɵadvance, ul as isSignal, uo as ɵɵdomElementEnd, va as ɵɵattribute, vc as EnvironmentInjector, vr as TemplateRef, wa as ɵɵconditionalCreate, wn as Directive, xl as signal, ya as ɵɵclassMap, yo as ɵɵelementEnd, ys as ɵɵreference } from "./core-Cf1yj7rw.js";
import { i as Directionality, t as BidiModule } from "./bidi-schyyYqA.js";
import { jt as Location } from "./common-B_Pxou4v.js";
import { t as Platform } from "./_platform-chunk-C28Z2M7h.js";
import { C as supportsScrollBehavior, _ as ViewportRuler, i as CdkScrollableModule, m as ScrollingModule, p as ScrollDispatcher } from "./scrolling-COXiENFD.js";
import { t as _CdkPrivateStyleLoader } from "./_style-loader-chunk-R07DA7Dy.js";
import { FormGroupDirective, NgControl, NgForm, Validators } from "./@angular_forms.js";
import { n as LiveAnnouncer, o as _getEventTarget } from "./platform-Bx1lEObY.js";
import { t as _VisuallyHiddenLoader } from "./private-CqmkYHVz.js";
import { i as coerceArray, t as _animationsDisabled } from "./_animation-chunk-CtSAwOZR.js";
import { c as MatFormField, d as MatLabel, f as MatPrefix, l as MatFormFieldControl, p as MatSuffix, r as MAT_FORM_FIELD, s as MatError, t as MatFormFieldModule, u as MatHint, v as _IdGenerator } from "./form-field-hePZEv9i.js";
import { i as MatRipple, n as _StructuralStylesLoader, t as MatRippleModule } from "./_ripple-module-chunk-Bl4sXlm8.js";
import { n as ErrorStateMatcher, r as FORM_FIELD, t as _ErrorStateTracker } from "./_error-state-chunk-DaSwv5lX.js";
...
var Typeahead = class {
	_letterKeyStream = new import_cjs.Subject();
	_items = [];
	_selectedItemIndex = -1;
	_pressedLetters = [];
	_skipPredicateFn;
	_selectedItem = new import_cjs.Subject();
...
var ListKeyManager = class {
	...
	_wrap = false;
	_typeaheadSubscription = import_cjs.Subscription.EMPTY;
	...
	tabOut = new import_cjs.Subject();
	change = new import_cjs.Subject();
...
var SelectionModel = class {
	...
	changed = new import_cjs.Subject();
	bulk = {
...
var OverlayRef = class {
	...
	_injector;
	_renderer;
	_backdropClick = new import_cjs.Subject();
	_attachments = new import_cjs.Subject();
	_detachments = new import_cjs.Subject();
	_positionStrategy;
	_scrollStrategy;
	_locationChanges = import_cjs.Subscription.EMPTY;
	_backdropRef = null;
	_detachContentMutationObserver;
	_detachContentAfterRenderRef;
	_disposed = false;
	_previousHostParent;
	_keydownEvents = new import_cjs.Subject();
	_outsidePointerEvents = new import_cjs.Subject();
	_afterNextRenderRef;
...
var FlexibleConnectedPositionStrategy = class {
	...
	_positionChanges = new import_cjs.Subject();
	_resizeSubscription = import_cjs.Subscription.EMPTY;
	_offsetX = 0;
	_offsetY = 0;
...
var CdkConnectedOverlay = class CdkConnectedOverlay {
	...
	_overlayRef;
	_templatePortal;
	_backdropSubscription = import_cjs.Subscription.EMPTY;
	_attachSubscription = import_cjs.Subscription.EMPTY;
	_detachSubscription = import_cjs.Subscription.EMPTY;
	_positionSubscription = import_cjs.Subscription.EMPTY;
	_offsetX;
	_offsetY;
	_position;
	...
	attachOverlay() {
		...
		this._positionSubscription.unsubscribe();
		if (this.positionChange.observers.length > 0) this._positionSubscription = this._position.positionChanges.pipe((0, import_operators.takeWhile)(() => this.positionChange.observers.length > 0)).subscribe((position) => {
